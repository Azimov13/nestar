...
export class CommentResolver {
	...
	@UseGuards(AuthGuard) //Authmemberlagina ishlata oladi
	@Mutation((returns) => Comment) //comment dto ni qiymat sifatida return qiladi
	public async createComment(
		@Args('input') input: CommentInput,
		@AuthMember('_id') memberId: ObjectId, //memberID ni qabul qilamiz
	): Promise<Comment> {
	...
	@Roles(MemberType.ADMIN)//faqatgina ADMIN lar ishlata oladi 
