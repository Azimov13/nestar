...
export class BoardArticleService {
	...
	public async getBoardArticle(
		...
		}; //searching objectni hosil qilyamiz&& active articlelarni kora oladi

		const targetBoardArticle: BoardArticle = await this.boardArticleModel
			.findOne(search)
			.lean() //modify imkoniyatiga ega bolishimiz kerak
			.exec();
		...
		if (memberId) {
			...
			}; //murojatchi Auth bolgan bolsa shu mantiq ishga tushadi
			//agarda view birinchi marta bolayotgan bolsa view 1ga oshir degan mantiqni yaratib olyamiz
